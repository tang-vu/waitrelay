...
const probes: readonly Probe[] = [
  ...
  { slug: "choice-late", name: "Choice after lock", scenario: "late", expected: "Honest tooLate ACK", evidence: "Interactive", instructions: "Wait for Verifying, then choose the retained gate. The dedicated probe leaves four seconds to inspect the authoritative tooLate ACK before completion." },
